...
// SDP = What can we communicate?
// ICE (Interactive Connectivity Establishment) = How can we physically reach each other?
// DTLS = How do we secure it?
// SRTP = How do we transport media?
// new RTCPeerConnection(...)

// In practice, when a WebRTC call fails, the cause is very often an ICE problem (candidate gathering,
// NAT traversal, firewall restrictions, or missing TURN servers),
// not the audio/video code itself.
