...
![Installation folder](DEVEL-stage.png?raw=true "C: drive after decompress https://courseware.deepcloudlabs.com/software/DEVEL-stage.2025a-nodejs.mongo.webstorm.zip")
